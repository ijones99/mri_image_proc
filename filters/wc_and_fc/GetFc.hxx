...
//    ->SetFcScale(DOUBLE VAL, FC_SCALE);
...
GetFc<TI0, TPc, TI1, TA, TOut>::GetFc()
{
...
template<  typename TI0, typename TPc, typename TI1,typename TA, typename TOut>
void GetFc<TI0, TPc, TI1, TA, TOut>::SetInputI0(const TI0* i0)
{
    this->SetNthInput(0, const_cast<TI0*>(i0));
}

template<  typename TI0, typename TPc, typename TI1,typename TA, typename TOut>
void GetFc<TI0, TPc, TI1, TA, TOut>::SetInputPc(const TPc* pc)
{
    this->SetNthInput(1, const_cast<TPc*>(pc));
}
template<  typename TI0, typename TPc, typename TI1,typename TA, typename TOut>
void GetFc<TI0, TPc, TI1, TA, TOut>::SetInputI1(const TI1* i1)
{
    this->SetNthInput(2, const_cast<TI1*>(i1));
}

template<  typename TI0, typename TPc, typename TI1,typename TA, typename TOut>
void GetFc<TI0, TPc, TI1, TA, TOut>::SetInputA(const TA* a)
{
    this->SetNthInput(3, const_cast<TA*>(a));
}
//------------------------------------------------
template<  typename TI0, typename TPc, typename TI1,typename TA, typename TOut>
typename TI0::ConstPointer GetFc<TI0, TPc, TI1, TA, TOut>::GetInputI0()
{
    return static_cast< const TI0 * >
           ( this->ProcessObject::GetInput(0) );
}
template<  typename TI0, typename TPc, typename TI1,typename TA, typename TOut>
typename TPc::ConstPointer GetFc<TI0, TPc, TI1, TA, TOut>::GetInputPc()
{
    return static_cast< const TPc * >
           ( this->ProcessObject::GetInput(1) );
}
template<  typename TI0, typename TPc, typename TI1,typename TA, typename TOut>
typename TI1::ConstPointer GetFc<TI0, TPc, TI1, TA, TOut>::GetInputI1()
{
...
template<  typename TI0, typename TPc, typename TI1,typename TA, typename TOut>
typename TA::ConstPointer GetFc<TI0, TPc, TI1, TA, TOut>::GetInputA()
{
...
template<  typename TI0, typename TPc, typename TI1,typename TA, typename TOut>
void GetFc<TI0, TPc, TI1, TA, TOut>::GenerateData()
{
    /*
     ...
     */
    const double SCALE = this->GetFcScale();
    ...
    for (int m=0; m<=regionSize[2]-1; m++) // y-axis
    {
...
DataObject::Pointer GetFc<TI0, TPc, TI1, TA, TOut>::
...
template<  typename TI0, typename TPc, typename TI1,typename TA, typename TOut>
TOut* GetFc<TI0, TPc, TI1, TA, TOut>::GetOutput()
{
