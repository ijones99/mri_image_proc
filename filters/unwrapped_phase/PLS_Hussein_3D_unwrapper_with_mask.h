/*=======================================================================================================================
	...
	published in the Journal Applied Optics, Vol. 46, No. 26, pp. 6623-6635, 2007.
	This program was written on 29th August 2007
	The wrapped phase volume is assumed to be of doubleing point data type. The unwrapped phase volume is also of doubleing point type.
	...
	This program was changed by PLS (AIM-Paris) in 01-30-2010
	Now, external parameters can be passed to the program

	Ex: PLS_Hussein_3D_unwrapper_with_mask 256 192 128
...
#define swap2(x,y) {EDGE t; t=x; x=y; y=t;}
#define order(x,y) if (x.reliab > y.reliab) swap2(x,y)
...
void calculate_reliability(double *wrappedVolume, VOXELM *voxel, int volume_width, int volume_height, int volume_depth)
{
    int frame_size  = volume_width * volume_height;
...
void  unwrapVolume(VOXELM *voxel, int volume_width, int volume_height, int volume_depth)
{
    ...
    {
        if (voxel_pointer->value < minVal )
            {minVal = voxel_pointer->value ;}
...
void  returnVolume(VOXELM *voxel, double *unwrappedVolume, int volume_width, int volume_height, int volume_depth)
{
    ...
    for (i=0; i < volume_size; i++)
    {
        *unwrappedVolume_pointer = voxel_pointer->value * 0.5; // add mult of 0.5 from Matlab code (Dixon3D)
        voxel_pointer++;
...
{
double *WrappedVolume, *UnwrappedVolume;
unsigned char *input_mask, *extended_mask;
int volume_width = atoi(argv[1]);
int volume_height = atoi(argv[2]);
int volume_depth = atoi(argv[3]);
...
WrappedVolume = (double *) calloc(volume_size, sizeof(double));
//read_data("simtest.dat", WrappedVolume, volume_size);
//	char *fileName1 = "/home/research/Desktop/ijones/project_01/matlab/wrapped_phase.dat";
char* fileName1 = (char*) malloc(strlen("/home/research/Desktop/ijones/project_01/matlab/wrapped_phase.dat"));
strcpy(fileName1,"/home/research/Desktop/ijones/project_01/matlab/wrapped_phase.dat");
read_data(fileName1, WrappedVolume, volume_size);
...
char* fileName2  = (char*) malloc(strlen("/home/research/Desktop/ijones/project_01/matlab/mask3d.dat"));
strcpy(fileName2 ,"/home/research/Desktop/ijones/project_01/matlab/mask3d.dat");
read_mask(fileName2, input_mask, volume_size);
...
char* fileNameOut = (char*) malloc(strlen("/home/research/Desktop/ijones/project_01/matlab/unwrapped.dat"));
strcpy(fileNameOut,"/home/research/Desktop/ijones/project_01/matlab/unwrapped.dat");
write_data(fileNameOut, UnwrappedVolume, volume_size);
